...
namespace CSAPData
{
  ...
  /// </summary>
  [RfcStructure(AbapName ="BAPI_ACT_MILESTONE_EXP" , Length = 166, Length2 = 326)]
  [Serializable]
  public class BAPI_ACT_MILESTONE_EXP : SAPStructure
  {
    ...
    [RfcField(AbapName = "DELETION_FLAG", RfcType = RFCTYPE.RFCTYPE_CHAR, Length = 1, Length2 = 2, Offset = 165, Offset2 = 324)]
