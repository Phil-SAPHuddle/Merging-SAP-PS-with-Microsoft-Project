...
namespace CSAPData
{
  ...
  /// <summary>
  /// BAPI Structure for Milestones under WBS Elements
  /// </summary>
  [RfcStructure(AbapName ="BAPI_WBS_MILESTONE" , Length = 173, Length2 = 340)]
  [Serializable]
  public class BAPI_WBS_MILESTONE : SAPStructure
  {
